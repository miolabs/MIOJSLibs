...
var MUICalendarCell = (function (_super) {
    __extends(MUICalendarCell, _super);
    function MUICalendarCell() {
    ...
    MUICalendarCell.prototype.initWithLayer = function (layer, options) {
