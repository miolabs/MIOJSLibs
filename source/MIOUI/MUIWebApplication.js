...
var MUIWebApplication = (function () {
    ...
    MUIWebApplication.prototype.beginSheetViewController = function (vc) {
    ...
    MUIWebApplication.prototype.endSheetViewController = function () {
    ...
    MUIWebApplication.prototype.observeValueForKeyPath = function (key, type, object) {
        /*        if (type == "will")
                {
    ...
    MUIWebApplication.prototype.forwardResizeEvent = function (e) {
        if (this.ready == true)
            this.delegate.window.layout();
    };
    MUIWebApplication.prototype.forwardClickEvent = function (target, x, y) {
        if (this.ready == false)
            return;
        if (this._popUpMenu != null) {
