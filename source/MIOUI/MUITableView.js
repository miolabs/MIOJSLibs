...
(function (MUITableViewCellAccessoryType) {
    ...
    MUITableViewCellAccessoryType[MUITableViewCellAccessoryType["Detail"] = 1] = "Detail";
    MUITableViewCellAccessoryType[MUITableViewCellAccessoryType["DetailDisclosoure"] = 2] = "DetailDisclosoure";
...
(function (MUITableViewCellSeparatorStyle) {
    ...
    MUITableViewCellSeparatorStyle[MUITableViewCellSeparatorStyle["SingleLineEtched"] = 2] = "SingleLineEtched"; // TODO
...
var MUITableViewCell = (function (_super) {
    ...
    MUITableViewCell.prototype.initWithLayer = function (layer, options) {
...
var MUITableView = (function (_super) {
    ...
    MUITableView.prototype.initWithLayer = function (layer, options) {
        _super.prototype.initWithLayer.call(this, layer, options);
    ...
    MUITableView.prototype._addHeaderWithLayer = function (subLayer) {
    ...
    MUITableView.prototype._addFooterWithLayer = function (subLayer) {
    ...
    MUITableView.prototype._addCellPrototypeWithLayer = function (subLayer) {
    ...
    MUITableView.prototype.layout = function () {
    ...
    //     return selected;
    // }
    MUITableView.prototype.cellAtIndexPath = function (row, section) {
    ...
    MUITableView.prototype.selectCellAtIndexPath = function (row, section) {
    ...
    MUITableView.prototype.deselectCellAtIndexPath = function (row, section) {
