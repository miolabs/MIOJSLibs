var MIOBundle_Webworker = (function () {
    function MIOBundle_Webworker() {
        this.baseURL = null;
    ...
    MIOBundle_Webworker.prototype._loadCSS = function (basePath, path) {
    ...
    MIOBundle_Webworker.prototype.loadHMTLFromPath = function (path, layerID, target, completion) {
    ...
    MIOBundle_Webworker.prototype.checkQueue = function () {
    ...
    MIOBundle_Webworker.prototype.layerDidDownload = function (layer) {
        var item = this._layoutQueue[0];
        this._isDownloadingResource = false;
        item["Layer"] = layer;
        var key = item["Key"];
    ...
    MIOBundle_Webworker.prototype._checkDownloadCount = function () {
        if (this._isDownloadingResource == true)
            return;
