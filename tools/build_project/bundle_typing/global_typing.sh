...
python ./tools/build_project/bundle_typing/utils/proccess_bundle.py ./packages/${PACKAGENAME}/build/types/${NAME}.d.ts --legacy --target ./packages/${PACKAGENAME}/dist/typings/${PACKAGENAME}/index.d.ts
